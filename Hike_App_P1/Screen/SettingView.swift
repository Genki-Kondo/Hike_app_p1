            ...
            Section{
                ...
                VStack(spacing: 8){
                    Text("Where can you find \nperfect tracks?")
                        .font(.title2)
                        .fontWeight(.heavy)
                    Text("Teh hike which looks gorgeous in photos but is even better once you are actually there. The hike that you hope to do again someday. \nFind the best day hikes in the app.")
                        .font(.footnote)
                        .italic()
...
//                LabeledContent("Application", value: "Hike")
                ...
                CustomListRowView(rowLabel: "Applicaton", rowIcon: "apps.iphone", rowContent: "HIKE", rowTintColor: .blue)
